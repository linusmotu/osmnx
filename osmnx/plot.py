...
# For routes generated by the distributed routing
def plot_distributed_graph_route(G, route, bbox=None, fig_height=6, fig_width=None,
                     margin=0.02, bgcolor='w', axis_off=True, show=True,
                     save=False, close=True, file_format='png', filename='temp',
                     dpi=300, annotate=False, node_color='#999999',
                     node_size=15, node_alpha=1, node_edgecolor='none',
    ...
    def test(route):
        ...
        while not is_done:
            try:
                ...
                remaining_route.insert(0, route[-1])
                route = route[:-1]
                is_done = False
                
    remaining_route = test(route)
    while remaining_route:
        remaining_route = test(remaining_route)
...
def plot_graph_two_routes_with_labels(G, routes, bbox=None, fig_height=6, fig_width=None,
                      margin=0.02, bgcolor='w', axis_off=True, show=True,
                      save=False, close=True, file_format='png', filename='temp',
                      dpi=300, annotate=False, node_color='#999999',
                      node_size=15, node_alpha=1, node_edgecolor='none',
